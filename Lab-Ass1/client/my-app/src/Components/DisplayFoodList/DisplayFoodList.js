  ...
  <tr>
    <td>
      ...
      <button
        ...
        style={{ color: " #a04949", background: "none", border: "none", padding: "0", cursor: "pointer" }}
      >
        <img src="https://user-images.githubusercontent.com/37651620/142769328-23d55107-8bed-4fa0-92b8-cca7df931083.png" alt="delete" style={{ height: "40px" }} />
      </button>
    </td>
